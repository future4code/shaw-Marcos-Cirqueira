...
function marketing (pessoas: Pessoas[] ): Pessoas[]{
    return pessoas.filter((profissao) => {
        return profissao.setor === SETORES.MARKETING && profissao.presencial === true
    })
}

console.log(marketing(pessoas));
